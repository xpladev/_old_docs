...
- [Xpla Station Chrome extension](../../learn/station/download/xpla-station-extension.md)
- Node.js version 16+
...
Now that `App.js` has inherited the context of `WalletProvider`, you can start putting your imports to work. You'll use the multi-purpose `useWallet` hook to connect your xpla station extension to your web browser.
...
5. Make sure your Xpla Station extension is connected to a wallet. Click **Connect EXTENSION**, and the app will connect to your wallet.
...
2. Populate `Tx.js` with the following:
   ...
   :::{note}
   Because all coins are denominated in micro-units, you will need to multiply any coins by $10^6$ . For example, 1000000000000000000 axpla = 1 XPLA.
   :::
