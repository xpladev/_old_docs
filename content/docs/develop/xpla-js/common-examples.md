...
:::{tip}
If you are new to Xpla and don't know where to start, visit the [getting started guide](../get-started.md).
:::
...
import { MsgSend, MnemonicKey, Coins, LCDClient } from "@c2xdev/xpla.js";
...
```ts
import { LCDClient, MnemonicKey, MsgSend } from "@c2xdev/xpla.js";
...
## Swapping a native Xpla asset for a CW20 token using Xplaswap
...
```ts
import { LCDClient, Tx } from "@c2xdev/xpla.js";
