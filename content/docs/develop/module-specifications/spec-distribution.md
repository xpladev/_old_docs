...
:::{important}
Passive distribution means that validators and delegators need to manually collect their fee rewards by [submitting withdrawal transactions](../Xplad/subcommands.md#tx-distribution-withdraw-rewards).
:::
